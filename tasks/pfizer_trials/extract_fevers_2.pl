...
my $aeFile     = "raw_data/pfizer_trials/xpt_files_to_csv/FDA-CBER-2021-5683-0764727-0765714-125742_S1_M5_c4591001-S-Supp-D-ae-supp.csv";
die "you must convert the ae file using readstats and place it in [raw_data/pfizer_trials/xpt_files_to_csv/FDA-CBER-2021-5683-0764727-0765714-125742_S1_M5_c4591001-S-Supp-D-ae-supp.csv] first." unless -f $aeFile;
...
while (<$in>) {
	...
	if ($dRNum == 1) {
		...
		# 	}
		# }
		$subjects{$subjectId}->{'aeListed'}->{$aeDate}->{$aeLlt} = $aeRel;
