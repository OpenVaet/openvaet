...
$cases{'10081302'}->{'sourceFile'} = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
...
$cases{'10931063'}->{'sourceFile'} = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
...
$cases{'10931122'}->{'sourceFile'} = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
...
$cases{'11101229'}->{'sourceFile'} = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
...
$cases{'11231171'}->{'sourceFile'} = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
...
$cases{'11331512'}->{'sourceFile'} = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
...
$cases{'11471037'}->{'sourceFile'} = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
...
$cases{'11681226'}->{'sourceFile'} = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
...
$cases{'11781118'}->{'sourceFile'} = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
...
$cases{'12262108'}->{'sourceFile'} = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
...
$cases{'12262235'}->{'sourceFile'} = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
...
$cases{'44441043'}->{'sourceFile'} = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
...
for my $subjectId (sort{$a <=> $b} keys %case2) {
	...
	if ($fileToIncrement) {
		...
		$cases{$subjectId}->{'sourceFile'}  = 'pd-production-050222/125742_S1_M5_5351_c4591001-interim-mth6-randomization-sensitive.pdf';
	} else {
		$cases{$subjectId}->{'sourceTable'} = '16.2.8.1';
		$cases{$subjectId}->{'sourceFile'}  = 'pd-production-040122/125742_S1_M5_5351_c4591001-fa-interim-randomization-sensitive.pdf';
	}
}
# die;
# p%cases;
