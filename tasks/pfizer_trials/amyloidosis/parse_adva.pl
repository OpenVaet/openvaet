...
my $advaFile      = "$dataFolder/FDA-CBER-2021-5683-0633945-0634074-125742_S1_M5_bnt162-01-S-D-adva.csv";
die "you must convert the adva file using readstats and place it in [raw_data/pfizer_trials/xpt_files_to_csv/FDA-CBER-2021-5683-0633945-0634074-125742_S1_M5_bnt162-01-S-D-adva.csv] first." unless -f $advaFile;
my %subjects      = ();
...
my $outputFolder   = "tasks/pfizer_trials/amyloidosis/adva";
make_path($outputFolder) unless (-d $outputFolder);

# Prints patients .CSV.
open my $out, '>:utf8', 'tasks/pfizer_trials/amyloidosis/adva.csv';
