...
# system("perl tasks/pfizer_trials/subjects_in_pdf_files.pl");
# system("perl tasks/pfizer_trials/subjects_in_sas_files.pl");
...
# system("perl tasks/pfizer_trials/extract_efficacy_cases.pl"); # --> 170 efficacy cases.
