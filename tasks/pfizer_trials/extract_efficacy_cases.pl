...
# public/pfizer_documents/native_files/pd-production-030122/125742_S1_M5_5351_c4591001-fa-interim-lab-measurements-sensitive.pdf
# page 66 to 99.
...
my $casesPdfFolder = "raw_data/pfizer_trials/cases_efficacy";
...
open my $out, '>:utf8', "$outputFolder/pfizer_trial_efficacy_cases.json";
